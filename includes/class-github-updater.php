<?php
/**
 * GitHub Auto-Updater for Notification Routing Importer
 *
...
class GFNRI_GitHub_Updater {
     ...
     * @var string
     */
    private const GITHUB_REPO = 'gf-notification-routing-importer';
     ...
     * @var string
     */
    private const PLUGIN_FILE = 'gf-notification-routing-importer/gf-notification-routing-importer.php';
     ...
     * @var string
     */
    private const PLUGIN_SLUG = 'gf-notification-routing-importer';
     ...
     * @var string
     */
    private const PLUGIN_NAME = 'Notification Routing Importer for Gravity Forms';
     ...
     * @var string
     */
    private const PLUGIN_DESCRIPTION = 'Bulk import notification routing rules into Gravity Forms from CSV or XLSX files.';
     ...
     * @var string
     */
    private const TEXT_DOMAIN = 'gf-notification-routing-importer';
     ...
     * @var string
     */
    private const CACHE_KEY = 'gfnri_github_release';
    ...
    public static function plugin_info_css(): void {
        ...
        // Add banner class and GF requirement sidebar line.
